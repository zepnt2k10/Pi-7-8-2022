...
%		\vspace*{-5pt}
%		\captionsetup{labelformat= empty, justification=centering}
%		\includegraphics[width=0.85\linewidth]{20.12-pi.4-2}
%		\vspace*{-10pt}
%	\end{figure}
%	\vskip 0.1cm
%	\textbf{\color{toancuabi}Số Trung Hoa cổ}
%	\vskip 0.1cm
%	Trung Hoa cổ đại cũng là một trong những nền văn minh cổ lớn của thế giới. Khoảng $3500$ năm trước, người Trung Hoa khắc lên những mảnh mai rùa những kí hiệu khác nhau thể hiện số và chữ. Một số trong đó như sau
%	\begin{figure}[H]
%		\centering
%%		\vspace*{-5pt}
%		\captionsetup{labelformat= empty, justification=centering}
...
%			\foreach \x in {1,3,...,7}{
%				\foreach \y in {1,3,...,7}{
%					\draw[fill=cackithi!50] (\x,\y) rectangle (\x+1, \y+1);
